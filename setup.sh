bash -c 'sudo pacman -S alacritty xterm wget dmenu picom xf86-input-libinput xmobar neofetch htop ncdu vim nano nnn xorg xorg-xinit p7zip flameshot pulseaudio-alsa pulseaudio-bluetooth pamixer tlp youtube-dl nitrogen chromium krita xdotool gimp mpv vlc audacity discord libreoffice-still ttc-iosevka ttc-iosevka-aile ttc-iosevka-curly ttf-bitstream-vera ttf-font ttf-nerd-fonts-symbols-mono base-devel'
